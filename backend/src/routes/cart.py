...
from src.models import CartItemPayload, CartItemUpdatePayload, CartResponse, CouponPayload
...
def add_cart_item(payload: CartItemPayload,service: CartService=Depends(get_cart_service)):
...
def update_cart_item(item_id: int, payload: CartItemUpdatePayload, service: CartService=Depends(get_cart_service)):
...
def delete_cart_item(item_id: int, service: CartService=Depends(get_cart_service)):
...
def apply_coupon(payload: CouponPayload, service: CartService=Depends(get_cart_service)):
